...
public class IAPManager : MonoBehaviour, IDetailedStoreListener
{
    ...
    public void OnPurchaseFailed(Product product, PurchaseFailureDescription failureDescription)
    {
        if (debug)
        {
            Debug.Log(this + "Buy Product failed for " + product.metadata.localizedTitle + " Failed. Reason: " + failureDescription.reason);
            ScreenWriter.Write(this + "Buy Product failed for " + product.metadata.localizedTitle + " Failed. Reason: " + failureDescription.reason);
        }

        if (OnCompleteMethod != null)
        {
            OnCompleteMethod(IAPOperationStatus.Fail, product.metadata.localizedTitle + " Failed. Reason: " + failureDescription.reason, null);
        }
    }
}
#else
